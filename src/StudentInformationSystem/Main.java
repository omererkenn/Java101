...
public class Main {
    public static void main(String[] args) {
        ...
        Student s1 = new Student("Ahmet","1","4",tarih,fizik,matematik);
        s1.addBulkExamlNote(30,40,80);
        s1.addBulkVerbalNote(70,55,90);
        s1.isPass();

        Student s2 = new Student("Hasan","2","2",tarih,fizik,matematik);
        s2.addBulkExamlNote(95,80,60);
        s2.addBulkVerbalNote(60,70,90);
        s2.isPass();

        Student s3 = new Student("Mustafa","4","3",tarih,fizik,matematik);
